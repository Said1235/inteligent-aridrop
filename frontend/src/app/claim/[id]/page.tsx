...
export default function ClaimPage() {
  ...
  const canSign = connected && !wrongNetwork;
          ...
          {!loading && notFound && draft ? (
            <section>
              ...
              <div className="mt-5 flex flex-wrap items-center gap-3">
                {connected ? (
                  <Button size="lg" onClick={submitEvidence} disabled={submitting || wrongNetwork}>
                  ...
                  <div className="mt-4 flex flex-wrap items-center gap-3">
                    {connected ? (
                      <Button
                        ...
                        disabled={evaluating || wrongNetwork || requirements.unconfigured}
                      >
